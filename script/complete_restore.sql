-- Add missing columns to match backup data
ALTER TABLE delivery_items ADD COLUMN IF NOT EXISTS price real DEFAULT 0;
ALTER TABLE delivery_items ADD COLUMN IF NOT EXISTS currency currency DEFAULT 'CNY';
ALTER TABLE delivery_items ADD COLUMN IF NOT EXISTS length real;
ALTER TABLE delivery_items ADD COLUMN IF NOT EXISTS width real;
ALTER TABLE delivery_items ADD COLUMN IF NOT EXISTS height real;
ALTER TABLE delivery_items ADD COLUMN IF NOT EXISTS weight real;
ALTER TABLE delivery_items ADD COLUMN IF NOT EXISTS pieces_per_carton integer;

ALTER TABLE containers ADD COLUMN IF NOT EXISTS invoice_number text;
ALTER TABLE containers ADD COLUMN IF NOT EXISTS container_number text;
ALTER TABLE containers ADD COLUMN IF NOT EXISTS shipping_company text;
ALTER TABLE containers ADD COLUMN IF NOT EXISTS price_cny real;
ALTER TABLE containers ADD COLUMN IF NOT EXISTS price_usd real;
